...
namespace Serilog
{
    ...
    public static class LoggerConfigurationDatadogExtensions
    {
            ...
            Action<Exception> exceptionHandler = null)
        {
            ...
            var config =
                ApplyMicrosoftExtensionsConfiguration.ConfigureDatadogConfiguration(configuration,
                    configurationSection);
            var sink = DatadogSink.Create(apiKey, source, service, host, tags, config, batchSizeLimit, batchPeriod,
                queueLimit, exceptionHandler);
